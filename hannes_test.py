...
mat3 = scipy.io.mmread('goddardRocketProblem_2.mtx')
...
delta = end-start
print "PCA(3)  took: ", delta, " seconds, for matrix: rocketman."
...
delta = end-start
print "Cov  took: ", delta, " seconds, for matrix: rocketman."
...
delta = end-start
print "SVD(3)  took: ", delta, " seconds, for matrix: rocketman."
